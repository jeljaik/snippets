function [ time, interpolatedSteps ] = partialInterpolateSSLeft( interpolatedSteps, feetCoordinates, index, time, gaitParams )
...
for t = tStart:tStep:tEnd
    ...
    interpolatedSteps.RightFootCoordinates{end+1} = [];
    time(end+1) = t;
end
